...
public class UserNotificationController {
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable(value = "userId")UUID userId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(notificationService.updateNotification(notificationRecordDto, notificationService.findNotificationIdAndUserId(notificationId,userId).get()));
